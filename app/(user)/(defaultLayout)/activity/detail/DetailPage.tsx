...
const DetailPage = ({ article }: { article: articleType }) => {
    ...
    >
      ...
      <div className="h-[calc(100%-575px)] flex">
        <motion.div
          ...
          className="relative h-full hidden sm:block lg:w-[556px] md:w-[356px] w-[200px]"
        >
        ...
        <div className="w-full mt-[10px] pr-9 sm:pl-0 pl-9">
          ...
          <motion.p
            variants={childVariants}
            className={`${openSans400.className} md:text-[24px] text-[20px] whitespace-pre-wrap`}
          >
            {article.content}
          </motion.p>
        </div>
