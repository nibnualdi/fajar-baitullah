...
const SectionTwo = () => {
  return (
    <section className="h-[722px] relative flex justify-center items-center bg-white">
      <Swiper
        containerClassName="w-[1056px] max-h-[487px] h-[487px] rounded-[15px]"
        overlayClassName="w-[1056px] max-h-[487px] h-[487px] flex flex-col gap-[88px] py-[104px] px-[182px] bg-[rgba(34,34,34,0.50)] top-0 left-0"
